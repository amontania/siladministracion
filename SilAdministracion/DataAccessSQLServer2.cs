...
namespace MedusaSQLServer2
{
    ...
    public class DBUtilsServer2
    {
        ...
        private void Open()
        {
            try
            {
                Connection = new SqlConnection(GetConnectionString("SQLConnection2"));
        ...
        {
            string conConnectionString = ConfigurationManager.ConnectionStrings["SqlConnection2"].ConnectionString;
        ...
        public DataTable ProcedureSelect(string procedureName, List<DbParameter> parameters)
        {
            //Get connection string
            string conConnectionString = ConfigurationManager.ConnectionStrings["SqlConnection2"].ConnectionString;
            OleDbConnection SQLDatabaseConnection = new OleDbConnection(conConnectionString);
            ...
            DataSet dsPageInfo = new DataSet();
            OleDbDataAdapter daPageInfo = new OleDbDataAdapter();
          ...
          //  Command.Parameters.AddWithValue("@pAno", 2015);
          //  Command.Parameters.AddWithValue("@pMes", 3);
