...
namespace Medusa
{
    ...
    public class DBUtils
    {
        ...
        private void Open()
        {
            try
            {
                Connection = new MySqlConnection(GetConnectionString("MySQLConnection"));
        ...
        private void Open(string connect)
        {
            try
            {
                Connection = new MySqlConnection(GetConnectionString(connect));
        ...
        public DataSet DataSelect(MySqlCommand cmdSQLQuery)
        {
            string conConnectionString = ConfigurationManager.ConnectionStrings["MySQLConnection"].ConnectionString;
            ...
            MySqlDataAdapter daPageInfo = new MySqlDataAdapter(cmdSQLQuery);
        ...
        public  DataTable SQLSelect(MySqlCommand cmdSQLQuery)
        {
        ...
        public  void ExecuteSQLCommand(MySqlCommand CommandToExecute)
        {
        ...
        { 
            ...
            MySqlCommand cmdSQLQuery = new MySqlCommand();
            cmdSQLQuery.Connection = SQLDatabaseConnection;
            SQLDatabaseConnection.Open();
        ...
        public int ExecuteNonQuery(string connect,string procedureName, List<DbParameter> parameters)
        {
            int returnValue;
